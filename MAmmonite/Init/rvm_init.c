...
Input       : None.
Output      : rvm_ptr_t* VM_Num - The number of virtual machine images.
              rvm_ptr_t* Pgtbl_Num - The number of page tables.
Return      : None.
******************************************************************************/
void RVM_VM_Cnt(rvm_ptr_t* VM_Num, rvm_ptr_t* Pgtbl_Num)
{
    rvm_ptr_t VM_Cnt;
    rvm_ptr_t Pgtbl_Cnt;
...
Input       : struct RVM_Image** Image - The pointer to the pointer to the image.
              rvm_ptr_t* Pgtbl_Bump - the pointer to the pgtbl captbl bump pointer.
              rvm_ptr_t* Kmem_Bump - The kernel memory bump pointer.
              rvm_ptr_t VMID - The ID of the virtual machine.
Output      : struct RVM_Image** Image - The pointer to the pointer to the image.
              rvm_ptr_t* Pgtbl_Bump - the pointer to the pgtbl captbl bump pointer.
              rvm_ptr_t* Kmem_Bump - The kernel memory bump pointer.
Return      : None.
******************************************************************************/
void RVM_Load_Image(struct RVM_Image** Image, rvm_ptr_t* Pgtbl_Bump, rvm_ptr_t* Kmem_Bump, rvm_ptr_t VMID)
{
    rvm_ptr_t Count;
...
Input       : rvm_ptr_t* Kmem_Bump - The kernel memory bump pointer position, before allocations.
Output      : rvm_ptr_t* Kmem_Bump - The kernel memory bump pointer position, after allocations.
Return      : None.
******************************************************************************/
void RVM_VM_Init(rvm_ptr_t* Kmem_Bump)
{
    rvm_cnt_t Count;
    rvm_ptr_t VM_Num;
    rvm_ptr_t Pgtbl_Num;
...
Input       : rvm_ptr_t Bump_Ptr - The bump pointer for allocation.
Output      : None.
...
void RVM_Guard_Daemon(void)
{
    ...
    while(1)
    {
        ...
        RVM_LOG_SISUS("GUARD:Guard daemon activated for VMID ", VMID, " @ address 0x", (rvm_ptr_t)RVM_Cur_Virt, ".\r\n");
        ...
        RVM_ASSERT(RVM_Thd_Exec_Set(RVM_VIRT_USERTHD(VMID), (rvm_ptr_t)(RVM_Cur_Virt->Image->User_Entry), 
                                    RVM_Stack_Init((rvm_ptr_t)(RVM_Cur_Virt->Image->User_Stack),RVM_Cur_Virt->Image->User_Size),0)==0);
        RVM_ASSERT(RVM_Thd_Exec_Set(RVM_VIRT_INTTHD(VMID), (rvm_ptr_t)(RVM_Cur_Virt->Image->Int_Entry), 
                                    RVM_Stack_Init((rvm_ptr_t)(RVM_Cur_Virt->Image->Int_Stack),RVM_Cur_Virt->Image->Int_Size),0)==0);
...
Input       : struct RVM_Virt* Virt - The pointer to the virtual machine.
              rvm_ptr_t Int_Num - The virtual interrupt number.
Output      : None.
Return      : None.
******************************************************************************/
...
Input       : rvm_cnt_t Vect_Num - The physical interrupt number to process.
Output      : None.
Return      : None.
******************************************************************************/
