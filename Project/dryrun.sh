...
cp -f ../Utility/M7M02_Projgen/Release/rvgen.exe ../Utility/M7M02_Final/rvgen.exe
...
COMMAND="$RVGEN -p $1 -k $KERNEL -m $MONITOR -rmp $RMP -frt $FRT -w $WORKSPACE -r report.txt -v -d"
echo $COMMAND
$COMMAND > ./log.txt
