...
class RVM_Gen
{
    ...
    void Macro_Virtep(std::unique_ptr<class Para>& Para);
    ...
    void Virtmap_Crt(std::unique_ptr<class Para>& Para);
    void Virtep_Crt(std::unique_ptr<class Doc>& Doc);
    ...
    void Virtcap_Init(std::unique_ptr<class Doc>& Doc);
    void Captbl_Init(std::unique_ptr<class Doc>& Doc);
    void Pgtbl_Con(std::unique_ptr<class Para>& Para, class Pgtbl* Pgtbl);
