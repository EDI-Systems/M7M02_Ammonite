...
#define RME_GEN_ENABLE                                  (RME_TRUE)
/* Modifiable ****************************************************************/
/* The virtual memory start address for the kernel objects */
#define RME_KMEM_VA_START                               (0x10000B40)
/* The size of the kernel object virtual memory */
#define RME_KMEM_SIZE                                   (0x18C0)
