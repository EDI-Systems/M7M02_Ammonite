...
#define RME_KMEM_VA_START                               (0x2000C400)
/* The size of the kernel object virtual memory */
#define RME_KMEM_SIZE                                   (0x2800)
...
#define RME_KMEM_STACK_ADDR                             (0x2000FBF0)
...
#define RME_A7M_VECT_FLAG_ADDR                          (0x2000FE00)
/* Shared interrupt flag region address - always 512B memory for ARMv7-M */
#define RME_A7M_EVT_FLAG_ADDR                           (0x2000FC00)
/* Initial kernel object frontier limit */
#define RME_A7M_KMEM_BOOT_FRONTIER                      (0x2000CC40)
...
#define RME_A7M_SYSTICK_VAL                             (21600)
