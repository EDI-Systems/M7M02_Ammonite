...
#define RVM_KMEM_VA_START                               (0x10000B40)
/* The size of the kernel object virtual memory */
#define RVM_KMEM_SIZE                                   (0x18C0)
...
#define RVM_SFTD_STACK_BASE                             (0x10006000)
#define RVM_SFTD_STACK_SIZE                             (0x800)
#define RVM_TIMD_STACK_BASE                             (0x10004800)
#define RVM_TIMD_STACK_SIZE                             (0x800)
#define RVM_VMMD_STACK_BASE                             (0x10005800)
#define RVM_VMMD_STACK_SIZE                             (0x800)
#define RVM_VCTD_STACK_BASE                             (0x10005000)
#define RVM_VCTD_STACK_SIZE                             (0x800)
