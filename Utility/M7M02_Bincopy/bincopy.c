...
int main(int argc, char* argv[])
{
	...
	fprintf(Output_File,"              Size of array: %d bytes.\n",Input_Size);
	...
	fprintf(Output_File,"              When using LTO, make sure this file is exempt from the LTO option,\n");
	...
	printf("Size of image source file: %d bytes.\n",Input_Size);
