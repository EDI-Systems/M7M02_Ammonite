...
private:
    ...
    ptr_t Pgtbl_Tot_Ord(std::vector<std::unique_ptr<class Mem>>& List, ptr_t* Base_Addr);
    ptr_t Pgtbl_Num_Ord(std::vector<std::unique_ptr<class Mem>>& List, ptr_t Total_Order, ptr_t Base_Addr);
...
public:
    ...
    ptr_t Endianness;
    /* Number of total MPU regions */
    ptr_t Regions;
    /* Number of total static MPU regions used in one derivation of the page table */
    ptr_t Static_Regions;
