...
#define RV32P_RAW_PGT_SIZE_NOM(O)               ((4+POW2(O))*4)
#define RV32P_RAW_PGT_SIZE_TOP(O, R)             (((1+(R)*2)*4)+RV32P_RAW_PGT_SIZE_NOM(O))
#define RV32P_RAW_HYP_SIZE                       (84)
#define RV32P_RAW_REG_SIZE                       (48)
#define RV32P_RAW_REG_FPU_SIZE                   (112)
