...
void A7M_Gen::Kernel_Conf_Hdr(std::unique_ptr<std::vector<std::string>>& List)
{
    ...
    Proj_Gen::Macro_Hex(List, "RME_A7M_INIT_ENTRY",PRC_DESC_ALIGN(this->Proj->Monitor->Code_Base)|0x01, MACRO_REPLACE);
    /* Init process's first thread's stack address */
    Proj_Gen::Macro_Hex(List, "RME_A7M_INIT_STACK",
                        this->Proj->Monitor->Init_Stack_Base+this->Proj->Monitor->Init_Stack_Size-16, MACRO_REPLACE);
    /* What is the NVIC priority grouping? */
    Proj_Gen::Macro_String(List,"RME_A7M_NVIC_GROUPING",
    ...
    Proj_Gen::Macro_String(List, "RME_A7M_SYSTICK_VAL", this->Proj->Chip->Config["Systick_Value"]+"U", MACRO_REPLACE);

    /* Fixed attributes - we will refill these with database values */
    /* Number of MPU regions available */
    Proj_Gen::Macro_Int(List, "RME_A7M_REGION_NUM", this->Chip->Region, MACRO_REPLACE);
...
{
    /* Init process's first thread's entry point address is always at head */
    Proj_Gen::Macro_Hex(List, "RVM_A7M_INIT_ENTRY", PRC_DESC_ALIGN(this->Proj->Monitor->Code_Base)|0x01, MACRO_REPLACE);
    /* Init process's first thread's stack address */
    Proj_Gen::Macro_Hex(List, "RVM_A7M_INIT_STACK",
                        this->Proj->Monitor->Init_Stack_Base+this->Proj->Monitor->Init_Stack_Size-16, MACRO_REPLACE);
    /* Fixed attributes - we will refill these with database values */
    /* Number of MPU regions available */
    Proj_Gen::Macro_Int(List, "RVM_A7M_REGION_NUM", this->Chip->Region, MACRO_REPLACE);
