...
/* Putchar macro */
#define RVM_PUTCHAR(CHAR)                           RVM_RV32P_PUTCHAR(CHAR)
...
RVM_EXTERN rvm_ret_t RVM_Svc(rvm_ptr_t Op_Cid,
                             ...
                             rvm_ptr_t Arg2,
                             rvm_ptr_t Arg3);
RVM_EXTERN rvm_ret_t RVM_RV32P_Svc_Kfn(rvm_ptr_t Op_Cid,
                                       rvm_ptr_t ID,
                                       rvm_ptr_t* Param);
/* Invocation */
...
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Kfn_Act(rvm_cid_t Cap_Kern,
                                           rvm_ptr_t Func_ID,
                                           rvm_ptr_t Sub_ID,
                                           rvm_ptr_t* Param);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Pgt_Entry_Mod(rvm_cid_t Cap_Kfn,
                                                 rvm_cid_t Cap_Pgt,
                                                 rvm_ptr_t Vaddr,
                                                 rvm_ptr_t Type);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Int_Local_Mod(rvm_cid_t Cap_Kfn,
                                                 rvm_ptr_t Int_Num,
                                                 rvm_ptr_t Operation,
                                                 rvm_ptr_t Param);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Int_Local_Trig(rvm_cid_t Cap_Kfn,
                                                  rvm_ptr_t Int_Num);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Cache_Mod(rvm_cid_t Cap_Kfn,
                                             rvm_ptr_t Cache_ID,
                                             rvm_ptr_t Operation,
                                             rvm_ptr_t Param);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Cache_Maint(rvm_cid_t Cap_Kfn,
                                               rvm_ptr_t Cache_ID,
                                               rvm_ptr_t Operation,
                                               rvm_ptr_t Param);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Prfth_Mod(rvm_cid_t Cap_Kfn,
                                             rvm_ptr_t Prfth_ID,
                                             rvm_ptr_t Operation,
                                             rvm_ptr_t Param);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Perf_CPU_Func(rvm_cid_t Cap_Kfn,
                                             rvm_ptr_t Freg_ID,
                                             rvm_ptr_t* Content);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Perf_Mon_Mod(rvm_cid_t Cap_Kfn,
                                                rvm_ptr_t Perf_ID,
                                                rvm_ptr_t Operation,
                                                rvm_ptr_t Param);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Perf_Cycle_Mod(rvm_cid_t Cap_Kfn,
                                                  rvm_ptr_t Cycle_ID, 
                                                  rvm_ptr_t Operation,
                                                  rvm_ptr_t Value,
                                                  rvm_ptr_t* Content);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Debug_Print(rvm_cid_t Cap_Kfn,
                                               char Char);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Debug_Reg_Mod(rvm_cid_t Cap_Kfn,
                                                 rvm_cid_t Cap_Thd, 
                                                 rvm_ptr_t Operation,
                                                 rvm_ptr_t Value,
                                                 rvm_ptr_t* Content);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Debug_Inv_Mod(rvm_cid_t Cap_Kfn,
                                                 rvm_cid_t Cap_Thd, 
                                                 rvm_ptr_t Layer,
                                                 rvm_ptr_t Operation,
                                                 rvm_ptr_t Value,
                                                 rvm_ptr_t* Content);
__RVM_EXTERN__ rvm_ret_t RVM_RV32P_Debug_Exc_Get(rvm_cid_t Cap_Kfn,
                                                 rvm_cid_t Cap_Thd,
                                                 rvm_ptr_t Operation,
                                                 rvm_ptr_t* Content);
/* Monitor use only */ 
